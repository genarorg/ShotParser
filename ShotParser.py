...
def parse():
	...
	for clipitem in track.iter("clipitem"):
		...
		url = "Z:" + url.split("Z:")[1] #NOTE: windows paths only, maybe implement aliases?
...
def importToShotgun():
	...
	continueOption = raw_input(Fore.RED + "%s shots were found and will be created under %s, Continue? [y/n]: " % (len(clips), sgReel+"_"+sgSequence+"_"+sgScene))
	#continueOption = "y"
